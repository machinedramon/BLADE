uuid_services = {
    ...
    "00001120-0000-1000-8000-00805f9b34fb": "Direct Printing Ref Objects",
    ...
    "00001205-0000-1000-8000-00805f9b34fb": "Generic Telephony",
    ...
    "0000182a-0000-1000-8000-00805f9b34fb": "Insulin Delivery",
    "0000183a-0000-1000-8000-00805f9b34fb": "Binary Sensor",
    "0000183b-0000-1000-8000-00805f9b34fb": "Emergency Configuration",
    "0000183c-0000-1000-8000-00805f9b34fb": "Physical Activity Monitor",
    "0000183e-0000-1000-8000-00805f9b34fb": "Audio Input Control",
    "0000183f-0000-1000-8000-00805f9b34fb": "Volume Control",
    "00001840-0000-1000-8000-00805f9b34fb": "Volume Offset Control",
    "00001841-0000-1000-8000-00805f9b34fb": "Coordinated Set Identification Service",
    "00001842-0000-1000-8000-00805f9b34fb": "Device Time",
    "00001843-0000-1000-8000-00805f9b34fb": "Media Control Service",
    "00001844-0000-1000-8000-00805f9b34fb": "Generic Media Control Service",
    "00001845-0000-1000-8000-00805f9b34fb": "Constant Tone Extension",
    "00001846-0000-1000-8000-00805f9b34fb": "Telephone Bearer Service",
    "00001847-0000-1000-8000-00805f9b34fb": "Generic Telephone Bearer Service",
    "00001848-0000-1000-8000-00805f9b34fb": "Microphone Control",
    "00001849-0000-1000-8000-00805f9b34fb": "Audio Stream Control Service",
    "0000184a-0000-1000-8000-00805f9b34fb": "Network Availability Service",
    "0000184b-0000-1000-8000-00805f9b34fb": "Network Configuration Service",
    "0000184c-0000-1000-8000-00805f9b34fb": "Device Orientation Service",
    "0000184d-0000-1000-8000-00805f9b34fb": "Language Service",
    "0000184e-0000-1000-8000-00805f9b34fb": "Barometric Pressure Trend",
    "0000184f-0000-1000-8000-00805f9b34fb": "Bond Management Service",
    "00001850-0000-1000-8000-00805f9b34fb": "Central Address Resolution",
    "00001851-0000-1000-8000-00805f9b34fb": "CGM Service",
    "00001852-0000-1000-8000-00805f9b34fb": "Transport Discovery Service",
    "00001853-0000-1000-8000-00805f9b34fb": "HTTP Proxy Service",
    "00001854-0000-1000-8000-00805f9b34fb": "Indoor Positioning Service",
    "00001855-0000-1000-8000-00805f9b34fb": "Pulse Oximeter Service",
    "00001856-0000-1000-8000-00805f9b34fb": "Body Composition Service",
    "00001857-0000-1000-8000-00805f9b34fb": "HTTP Proxy Service",
    "00001858-0000-1000-8000-00805f9b34fb": "Large Object Transfer Service",
    "00001859-0000-1000-8000-00805f9b34fb": "Fitness Machine Service",
    "0000185a-0000-1000-8000-00805f9b34fb": "Mesh Provisioning Service",
    "0000185b-0000-1000-8000-00805f9b34fb": "Mesh Proxy Service",
    "00002a00-0000-1000-8000-00805f9b34fb": "Device Name",
    "00002a01-0000-1000-8000-00805f9b34fb": "Appearance",
    "00002a02-0000-1000-8000-00805f9b34fb": "Peripheral Privacy Flag",
    "00002a03-0000-1000-8000-00805f9b34fb": "Reconnection Address",
    ...
    "00002a1f-0000-1000-8000-00805f9b34fb": "Temperature Celsius",
    "00002a20-0000-1000-8000-00805f9b34fb": "Temperature Fahrenheit",
    "00002a21-0000-1000-8000-00805f9b34fb": "Humidity",
    "00002a22-0000-1000-8000-00805f9b34fb": "True Wind Speed",
    "00002a23-0000-1000-8000-00805f9b34fb": "True Wind Direction",
    "00002a24-0000-1000-8000-00805f9b34fb": "Apparent Wind Speed",
    "00002a25-0000-1000-8000-00805f9b34fb": "Apparent Wind Direction",
    "00002a26-0000-1000-8000-00805f9b34fb": "Gust Factor",
    "00002a27-0000-1000-8000-00805f9b34fb": "Pollen Concentration",
    "00002a28-0000-1000-8000-00805f9b34fb": "UV Index",
    "00002a29-0000-1000-8000-00805f9b34fb": "Irradiance",
    "00002a2a-0000-1000-8000-00805f9b34fb": "Rainfall",
    "00002a2b-0000-1000-8000-00805f9b34fb": "Wind Chill",
    "00002a2c-0000-1000-8000-00805f9b34fb": "Heat Index",
    "00002a2d-0000-1000-8000-00805f9b34fb": "Dew Point",
    "00002a2e-0000-1000-8000-00805f9b34fb": "Trend",
    "00002a2f-0000-1000-8000-00805f9b34fb": "Descriptor Value Changed",
    "00002a30-0000-1000-8000-00805f9b34fb": "Aerobic Heart Rate Lower Limit",
    "00002a31-0000-1000-8000-00805f9b34fb": "Aerobic Threshold",
    "00002a32-0000-1000-8000-00805f9b34fb": "Age",
    "00002a33-0000-1000-8000-00805f9b34fb": "Anaerobic Heart Rate Lower Limit",
    "00002a34-0000-1000-8000-00805f9b34fb": "Anaerobic Heart Rate Upper Limit",
    "00002a35-0000-1000-8000-00805f9b34fb": "Anaerobic Threshold",
    "00002a36-0000-1000-8000-00805f9b34fb": "Aerobic Heart Rate Upper Limit",
    "00002a37-0000-1000-8000-00805f9b34fb": "Date of Birth",
    "00002a38-0000-1000-8000-00805f9b34fb": "Date of Threshold Assessment",
    "00002a39-0000-1000-8000-00805f9b34fb": "Email Address",
    "00002a3a-0000-1000-8000-00805f9b34fb": "Fat Burn Heart Rate Lower Limit",
    "00002a3b-0000-1000-8000-00805f9b34fb": "Fat Burn Heart Rate Upper Limit",
    "00002a3c-0000-1000-8000-00805f9b34fb": "First Name",
    "00002a3d-0000-1000-8000-00805f9b34fb": "Five Zone Heart Rate Limits",
    "00002a3e-0000-1000-8000-00805f9b34fb": "Gender",
    "00002a3f-0000-1000-8000-00805f9b34fb": "Heart Rate Max",
    "00002a40-0000-1000-8000-00805f9b34fb": "Height",
    "00002a41-0000-1000-8000-00805f9b34fb": "Hip Circumference",
    "00002a42-0000-1000-8000-00805f9b34fb": "Last Name",
    "00002a43-0000-1000-8000-00805f9b34fb": "Maximum Recommended Heart Rate",
    "00002a44-0000-1000-8000-00805f9b34fb": "Resting Heart Rate",
    "00002a45-0000-1000-8000-00805f9b34fb": "Sport Type for Aerobic and Anaerobic Thresholds",
    "00002a46-0000-1000-8000-00805f9b34fb": "Three Zone Heart Rate Limits",
    "00002a47-0000-1000-8000-00805f9b34fb": "Two Zone Heart Rate Limit",
    "00002a48-0000-1000-8000-00805f9b34fb": "VO2 Max",
    "00002a49-0000-1000-8000-00805f9b34fb": "Waist Circumference",
    "00002a4a-0000-1000-8000-00805f9b34fb": "Weight",
    "00002a4b-0000-1000-8000-00805f9b34fb": "Database Change Increment",
    "00002a4c-0000-1000-8000-00805f9b34fb": "User Index",
    "00002a4d-0000-1000-8000-00805f9b34fb": "Body Composition Feature",
    "00002a4e-0000-1000-8000-00805f9b34fb": "Body Composition Measurement",
    "00002a4f-0000-1000-8000-00805f9b34fb": "Weight Measurement",
    "00002a50-0000-1000-8000-00805f9b34fb": "Weight Scale Feature",
    "00002a51-0000-1000-8000-00805f9b34fb": "User Control Point",
    "00002a52-0000-1000-8000-00805f9b34fb": "Magnetic Flux Density - 2D",
    "00002a53-0000-1000-8000-00805f9b34fb": "Magnetic Flux Density - 3D",
    "00002a54-0000-1000-8000-00805f9b34fb": "Language",
    "00002a55-0000-1000-8000-00805f9b34fb": "Barometric Pressure Trend",
    "00002a55-0000-1000-8000-00805f9b34fb": "Barometric Pressure Trend",
    "00002a56-0000-1000-8000-00805f9b34fb": "Magnetic Flux Density - 2D",
    "00002a57-0000-1000-8000-00805f9b34fb": "Magnetic Flux Density - 3D",
    "00002a58-0000-1000-8000-00805f9b34fb": "Language",
    "00002a59-0000-1000-8000-00805f9b34fb": "Barometric Pressure Trend",
    "00002a5a-0000-1000-8000-00805f9b34fb": "Bond Management Control Point",
    "00002a5b-0000-1000-8000-00805f9b34fb": "Bond Management Feature",
    "00002a5c-0000-1000-8000-00805f9b34fb": "Central Address Resolution",
    "00002a5d-0000-1000-8000-00805f9b34fb": "CGM Measurement",
    "00002a5e-0000-1000-8000-00805f9b34fb": "CGM Feature",
    "00002a5f-0000-1000-8000-00805f9b34fb": "CGM Status",
    "00002a60-0000-1000-8000-00805f9b34fb": "CGM Session Start Time",
    "00002a61-0000-1000-8000-00805f9b34fb": "CGM Session Run Time",
    "00002a62-0000-1000-8000-00805f9b34fb": "CGM Specific Ops Control Point",
    "00002a63-0000-1000-8000-00805f9b34fb": "Indoor Positioning Configuration",
    "00002a64-0000-1000-8000-00805f9b34fb": "Latitude",
    "00002a65-0000-1000-8000-00805f9b34fb": "Longitude",
    "00002a66-0000-1000-8000-00805f9b34fb": "Local North Coordinate",
    "00002a67-0000-1000-8000-00805f9b34fb": "Local East Coordinate",
    "00002a68-0000-1000-8000-00805f9b34fb": "Floor Number",
    "00002a69-0000-1000-8000-00805f9b34fb": "Altitude",
    "00002a6a-0000-1000-8000-00805f9b34fb": "Uncertainty",
    "00002a6b-0000-1000-8000-00805f9b34fb": "Location Name",
    "00002a6c-0000-1000-8000-00805f9b34fb": "URI",
    "00002a6d-0000-1000-8000-00805f9b34fb": "HTTP Headers",
    "00002a6e-0000-1000-8000-00805f9b34fb": "HTTP Status Code",
    "00002a6f-0000-1000-8000-00805f9b34fb": "HTTP Entity Body",
    "00002a70-0000-1000-8000-00805f9b34fb": "HTTP Control Point",
    "00002a71-0000-1000-8000-00805f9b34fb": "HTTPS Security",
    "00002a72-0000-1000-8000-00805f9b34fb": "TDS Control Point",
    "00002a73-0000-1000-8000-00805f9b34fb": "OTS Feature",
    "00002a74-0000-1000-8000-00805f9b34fb": "Object Name",
    "00002a75-0000-1000-8000-00805f9b34fb": "Object Type",
    "00002a76-0000-1000-8000-00805f9b34fb": "Object Size",
    "00002a77-0000-1000-8000-00805f9b34fb": "Object First-Created",
    "00002a78-0000-1000-8000-00805f9b34fb": "Object Last-Modified",
    "00002a79-0000-1000-8000-00805f9b34fb": "Object ID",
    "00002a7a-0000-1000-8000-00805f9b34fb": "Object Properties",
    "00002a7b-0000-1000-8000-00805f9b34fb": "Object Action Control Point",
    "00002a7c-0000-1000-8000-00805f9b34fb": "Object List Control Point",
    "00002a7d-0000-1000-8000-00805f9b34fb": "Object List Filter",
    "00002a7e-0000-1000-8000-00805f9b34fb": "Object Changed",
}


def uuid_to_name(uuid):
    """Retorna um nome legível para um UUID dado."""
    return uuid_services.get(uuid.lower(), f"Unknown Service ({uuid})")
